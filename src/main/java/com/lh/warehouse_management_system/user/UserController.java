...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<?> createUser(@Valid RegisterRequest registerRequest) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateUser(@PathVariable Long id, @Valid UserUpdateDTO userUpdateDTO) {
